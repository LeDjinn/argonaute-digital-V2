...
export default function CardExperienceCustom({
  ...
  return (
    ...
    >
        ...
        >
          <div
            className="absolute inset-0 bg-gradient-to-br from-gray-900 via-gray-600  to-black opacity-100 z-0 
          ...
          <CardHeader className="relative z-20">
            ...
            <Badge className="absolute top-2 right-2 bg-black text-cyan-400 hover:bg-white">
              {category}
            </Badge>
              ...
              <div className="flex items-center">
                ...
                <span>
                  ...
                  {releaseDate
                    ...
                    : new Date("2023-06-15").toDateString()}
                </span>
              </div>
            </div>
          </CardContent>
